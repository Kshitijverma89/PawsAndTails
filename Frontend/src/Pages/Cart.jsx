...
const Cart = () => {
  ...
  const [cart, setCart] = useState([
    ...
    { id: 4, name: 'Pup 2', price: 7000, quantity: 2, image: 'https://images.unsplash.com/photo-1608096299210-db7e38487075?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8N3x8fGVufDB8fHx8fA%3D%3D', seller: 'Pet Shop B' },
    { id: 5, name: 'Pup 3', price: 6000, quantity: 1, image: 'https://images.unsplash.com/photo-1592769606534-fe78d27bf450?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTJ8fHxlbnwwfHx8fHw%3D', seller: 'Pet Shop C' },
  ]);
            ...
            <tbody>
              {cart.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td>
                  <img src={item.image} alt={item.name} className="product-image" />  </td>
                  <td>Rs.{item.price}</td> 
                  <td>
                    <input
                      type="number"
