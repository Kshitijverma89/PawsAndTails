  ...
  const products = [
    {
      ...
      description: 'Shih Tzus are known for their short snouts and large round eyes, as well as their long coat, floppy ears, and short and stout posture',
      Breed: 'Breed: Shih Tzu',
      price:  2449.99,
                  ...
                  <Card.Body>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex">
                        <Button variant="secondary" className="mr-2">{/* Quantity Decrease Button goes here */}-</Button>
                        <Button variant="secondary" className="mr-2">{/* Quantity Display goes here */}1</Button>
