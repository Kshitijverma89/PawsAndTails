            ...
            <Container fluid>
             ...
             <NavLink to="/Product1"><Button id="birds" onClick={pass2[0]}>Birds</Button></NavLink>
                        ...
                        <Nav.Link href="/About" className="nav-link-neon">
                            ...
                            <Nav.Link href="/SellerDashboard" className="nav-link-neon">
                                Dashboard
                            </Nav.Link>
                        ...
                        <div>
                            {user ? (
                                <NavDropdown title={user.username} id="basic-nav-dropdown">
                                    ...
                                    <NavDropdown.Item href="/Seller">Profile</NavDropdown.Item>
                                </NavDropdown>
                            ) : (admin ? (
                                <NavDropdown title={admin.username} id="basic-nav-dropdown">
                                    <NavDropdown.Item onClick={logout}>Logout</NavDropdown.Item>
                                    <NavDropdown.Item href="/Seller">Admin Dashboard</NavDropdown.Item>
                                </NavDropdown>
                            ) : (
